            ...
            <div className="bg-violet-gradient">
                <div className="max-w-7xl mx-auto px-4 flex items-center h-16 gap-4">
                    ...
                    <div className="flex items-center gap-3 ml-auto md:ml-0">
                        {/* Cart icon hidden as requested */}
                        <button onClick={openCart} style={{ display: 'none' }} className="relative flex items-center gap-1.5 text-white hover:text-white/80 transition-colors" aria-label="Cart">
